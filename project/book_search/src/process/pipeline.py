...
from src.process.polish.core import run_polish
from src.process.polish.embedding import run_polish_embedding
from src.process.taggers import CascadingTagger, LLMTagger
from src.utils import load_books_from_path
...
def _prepare_books_for_incremental_tagging(
    ...
    current_books = load_books_from_path(input_path)
