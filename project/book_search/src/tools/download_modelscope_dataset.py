...
# 使用共享工具函数
from src.tools.modelscope_utils import resolve_token  # noqa: E402
from src.tools.modelscope_utils import login_modelscope as _login_modelscope  # noqa: E402


def login_if_needed(token: str) -> None:
    if not token:
        return
    _login_modelscope(token)
